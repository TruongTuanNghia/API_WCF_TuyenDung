...
namespace API_WCF_TuyenDung
{
    ...
    public interface IJOBIT_TUYENDUNG
    {
        ...
        Stream updateCompany(INSERT_COMPANY_INPUT model);

        [OperationContract]
        [WebInvoke(Method = "POST", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json,
           UriTemplate = "/insertJod")]
        Stream insertJob(INSERT_JOB_INPUT model);

        [OperationContract]
        [WebInvoke(Method = "POST", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json,
          UriTemplate = "/updateJod")]
        Stream updateJob(UPDATE_JOB_INPUT model);

        [OperationContract]
        [WebInvoke(Method = "POST", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json,
          UriTemplate = "/getAllJod")]
        Stream GetAllJob(GET_ALL_JOB_INPUT model);
    }   
